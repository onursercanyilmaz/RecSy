...
class Splash_UI(object):
    def setupUi(self, Splash):
        if Splash.objectName():
            Splash.setObjectName(u"SplashScreen")
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        qim = QImage("C:/Users/onursercanyilmaz/Documents/GitHub/RecSy/img/RecSy.png")

        pix = QtGui.QPixmap.fromImage(qim.scaled(300,300))
        self.label_title.setPixmap(pix)
        self.label_title.hasScaledContents()
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: Onur Sercan Yılmaz", None))
    # retranslateUi