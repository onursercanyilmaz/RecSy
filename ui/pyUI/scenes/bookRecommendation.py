...
class Ui_BookRecommendationForm(object):
    def setupUi(self, BookRecommendationForm):
        BookRecommendationForm.setObjectName("MainWindow")
        BookRecommendationForm.resize(1200, 675)
        self.centralwidgetBookRecommendation = QtWidgets.QWidget(BookRecommendationForm)
        self.centralwidgetBookRecommendation.setObjectName("centralwidgetBookRecommendation")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.centralwidgetBookRecommendation)
        self.verticalLayout.setObjectName("verticalLayout")
        self.bookrecommendationsFrame = QtWidgets.QFrame(self.centralwidgetBookRecommendation)
...
"background: #37AED4;}")
        ...
        self.verticalLayout.addWidget(self.bookrecommendationsFrame)
        BookRecommendationForm.setCentralWidget(self.centralwidgetBookRecommendation)

        self.retranslateUi(BookRecommendationForm)
        self.list_bookRecommendations.setCurrentRow(-1)
        QtCore.QMetaObject.connectSlotsByName(BookRecommendationForm)
...
if __name__ == "__main__":
    ...
    BookRecommendationForm = MyWindow()
    """QtWidgets.QWidget()
    ui = Ui_MainForm()
    ui.setupUi(MainForm)"""
    #MainForm.show()
